...
public enum CkMechanism {
    ...
    CKM_X9_42_DH_PKCS_PARAMETER_GEN(0x00002002),
     ...
     */
    public static CkMechanism valueOf(int value) {
        for (CkMechanism ckMechanism : values()) {
            if (ckMechanism.value == value) {
                return ckMechanism;
            }
        }
        return null;
