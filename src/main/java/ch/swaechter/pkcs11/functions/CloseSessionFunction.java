...
/**
 * Close an existing session in the PKCS11 middleware.
 *
 * @author Simon Wächter
 */
public class CloseSessionFunction extends AbstractFunction {

    /**
     * Create a new function that closes an existing session in the PKCS11 middleware.
     *
     ...
     */
    public CloseSessionFunction(Linker linker, SymbolLookup loaderLookup, Template template) {
